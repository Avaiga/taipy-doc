...
These are the updates and changes introduced in Taipy version 2.3.
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } Scenario and Data Management Controls<br/>
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } New Taipy command-line interface (CLI). Please
  refer to the [Taipy command-line interface](../../userman/ecosystem/cli/index.md)
  documentation page for more information.
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } Users can now create a new Taipy application
...
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} Multi-line
...
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"}
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } The [`table`](../../refmans/gui/viselements/generic/table.md) and
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } [`chart`](../../refmans/gui/viselements/generic/chart.md)
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } The [`part` block](../../refmans/gui/viselements/generic/part.md)
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } The `navigate()^` function has an additional parameter called
...
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} Page scopes (how Taipy GUI finds bound variables in
...
- :octicons-bug-24:{ .bug-icon title="Bug fix" } The removal of all the
...
- :octicons-bug-24:{ .bug-icon title="Bug fix" } Styling of the
...
- :octicons-bug-24:{ .bug-icon title="Bug fix" } Some notifications (see `notify()^`) could be missed when
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } New exposed functions:
...
- :octicons-alert-fill-24:{ .alert-icon title="Deprecation" } The `Config.configure_default_data_node()`
  method has been deprecated. The `Config.set_default_data_node_configuration()^` method
  should be used instead.
- :octicons-alert-fill-24:{ .alert-icon title="Deprecation" } The `Config.configure_task_node()` method
  has been deprecated. The `Config.set_task_node_configuration()^` method should be used instead.
- :octicons-alert-fill-24:{ .alert-icon title="Deprecation" } The `Config.configure_pipeline_node()` method has been
  deprecated. The `Config.set_pipeline_node_configuration()^` method should be used instead.
- :octicons-alert-fill-24:{ .alert-icon title="Deprecation" } The `Config.configure_scenario_node()` method has
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } All scenarios grouped by their cycle can now be retrieved
  by calling `taipy.get_cycles_scenarios()^`.
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } All entities (cycles, scenarios, pipelines, tasks, data
  nodes, and jobs) expose two new methods: `get_label()` and `get_simple_label()`, that can be
  used to display the entity.
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } `taipy.get_entities_by_config_id()^` can be used to
  retrieve all entities that are based on the provided configuration identifier.
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } Commands for managing Taipy application versions can now
  be accessed via the `$ taipy manage-versions` command. Run `$ taipy manage-versions --help` for
  more details.
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } A version can now be renamed by running
  `$ taipy manage-versions --rename <old_version> <new_version>` from the CLI.
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } The configuration of a version can now be compared with
  another one by running
  `$ taipy manage-versions --compare-config <version_1> <version_2>` from the CLI.

<h4>Improvements and changes</h4>

- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} A generic data node can now be created defining only
  the *read_fct* parameter for a read-only data node, or only the *write_fct* parameter for a
  write-only data node.
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} The parameters *read_fct_params* and *write_fct_params*
...
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} The *validity_period* attribute of a data node is now
  exposed at the configuration level to set the up-to-date duration of a data node.
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} Add support for SQLAlchemy 2.0

<h4>Deprecations</h4>

- :octicons-alert-fill-24:{ .alert-icon title="Deprecation" } `PipelineConfig` has been deprecated and will be combined
  with `ScenarioConfig^` in future updates.
- :octicons-alert-fill-24:{ .alert-icon title="Deprecation" } `taipy.create_pipeline()` has been deprecated.
