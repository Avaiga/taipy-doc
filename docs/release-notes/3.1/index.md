...
- :octicons-bug-24:{ .bug-icon title="Bug fix" } Data is not shown or not automatically refreshed in
...
- :octicons-bug-24:{ .bug-icon title="Bug fix" } Data Nodes holding dates may not show in
...
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} Task nodes in the
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } The [`part`](../../refmans/gui/viselements/generic/part.md)
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } A new control called
...
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} The
  ...
  for the details.
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} The [`toggle`](../../refmans/gui/viselements/generic/toggle.md)
...
- :octicons-bug-24:{ .bug-icon title="Bug fix" } Selectors with dropdown menus cannot be deactivated.<br/>
  See [issue #894](https://github.com/Avaiga/taipy/issues/894).
- :octicons-bug-24:{ .bug-icon title="Bug fix" } Problems scoping non-global variables used in Partials.<br/>
  See [issue #561](https://github.com/Avaiga/taipy/issues/561).
- :octicons-bug-24:{ .bug-icon title="Bug fix" } Important error messages are mangled.<br/>
...
- :octicons-bug-24:{ .bug-icon title="Bug fix" } The signatures for `Config.configure_sql_data_node()`,
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } The `DataNode.filter()^` method and the
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } You can now append new data to a data node using the
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } A new class called `Submission^` holds meta-data (such as
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } `taipy.submit()^`, `Scenario.submit()^`,
  `Sequence.submit()^`, and `Task.submit()^` now return a `Submission^` entity.
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } A new predefined data node named `S3ObjectDataNode^`
...
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} Running twice the Orchestrator service raises an exception
  to prevent running multiple instances at the same time.
- :octicons-feed-rocket-16:{ .rocket-icon title="Improvement"} Running the Orchestrator service or creating an entity by
  `taipy.create_scenario()` or `taipy.create_global_data_node()` blocks the configuration from
  being modified.

<h4>Deprecations</h4>

- :octicons-alert-fill-24:{ .alert-icon title="Deprecation" } The `modin` exposed type as been deprecated. When used,
...
- :octicons-feed-plus-16:{ .plus-icon title="New feature" } A new job execution mode named *cluster mode*
