...
| [*x*](../chart.md#p-x)            | Volume values for stages  |  |
...
!!! example "Page content"
    ...
    === "HTML"
        ...
        ```html
        <taipy:chart type="funnel" x="Visits" y="Types"
            marker="{marker}" options="{options}">{data}</taipy:chart>
        ```
...
!!! example "Page content"
    ...
    === "HTML"
        ...
        ```html
        <taipy:chart type="funnelarea" values="Visits" text="Types" layout="layout"
            {data}</taipy:chart>
        ```
...
!!! example "Page content"
    ...
    === "HTML"
        ...
        ```html
        <taipy:chart type="funnelarea" values="{values}"
