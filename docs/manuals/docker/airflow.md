...
[docker-compose file](https://airflow.apache.org/docs/apache-airflow/stable/start/docker.html). However, Taipy needs
a custom version of this file, that you download from [this link](docker-compose.yml.md). Please download this file
...
Everything is already packaged in this [Dockerfile](Dockerfile.md). Please download it and copy it next to the main
...
password is `airflow`. Because the initialization of Airflow can be lengthy, the server URL may not be available
before a couple of minutes.
