...
-   `datanode.config_name` The name that identifies the data node.
...
-   `datanode.parent_id` The identifier of the parent (pipeline_id, scenario_id, cycle_id) or `None`
-   `datanode.last_edition_date` The date and time of the last edition
-   `datanode.job_ids` The ordered list of jobs that have written on this datanode
-   `datanode.validity_days` The number of days to be added to the data node validity duration
-   `datanode.validity_hours` The number of hours to be added to the data node validity duration
-   `datanode.validity_minutes` The number of minutes to be added to the data node validity duration
-   `datanode.edition_in_progress` The flag that signals if a task is currently computing this data node
-   `datanode.properties` The dict of additional arguments
