...
All the scenarios can be retrieved using the method `taipy.get_scenarios()^` which returns the
list of all existing scenarios. This method takes as the parameters:
