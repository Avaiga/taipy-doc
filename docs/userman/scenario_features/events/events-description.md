An `Event^` is an object emitted by Taipy to notify about change in the system.
It serves as a notification mechanism for any changes occurring
within Taipy, particularly those related to the Scenario and Data Management.
It is a crucial part of the system that allows tracking and responding to changes
in the various entities managed by Taipy, such as data nodes, jobs,
and scenarios.
