...
no version exists, and so legacy entities are not attached to any version. The overallprinciple
...
(Refer to [versioning documentation](../versioning/index.md) for details)
we propose the following migration paths:

# Using default or development mode

Please refer to the [Development mode](../versioning/development-mode.md)
...
Please refer to the [Experiment mode](../versioning/experiment-mode.md) or
[Production mode](../versioning/experiment-mode.md) documentation pages
for more
