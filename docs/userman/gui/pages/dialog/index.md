...
To create a dialog, you will use a [`dialog`](../../../../refmans/gui/viselements/generic/dialog.md)
control in your page. The dialog holds a page content or a *Partial* (see
[Partials](../partial/index.md)).
...
[`dialog`](../../../../refmans/gui/viselements/generic/dialog.md) control for more details and
examples.
