...
this [documentation](../../../userman/operations/running/notebooks.md) and follow the tutorial
accordingly.

### Installation

Ensure you have Python 3.9 through 3.12, then install Taipy:

```bash
pip install taipy
```

For the NLP feature (Python 3.9 and 3.10), install:
