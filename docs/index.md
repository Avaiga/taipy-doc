...
<div class="tp-row tp-row--gutter-sm">
  <div class="tp-col-12 tp-col-md-6 d-flex">
    <a class="tp-content-card" href="knowledge_base/tutorials/1_understanding_gui/">
  ...
  <div class="tp-col-12 tp-col-md-6 d-flex">
    <a class="tp-content-card" href="knowledge_base/tutorials/2_scenario_management_overview/">
      <header class="tp-content-card-header">
